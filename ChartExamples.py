...
btnChart2 = tk.Button(window, text='График 3', font = ('Helvetica', 10, 'bold'), command=chart3.plot_chart)
btnChart2.place(x=40, y=215, width=90, height=30)

lblChart2 = tk.Label(text='3D поверхность')
lblChart2.place(x=170, y=220)
